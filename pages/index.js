  ...
  return (
    <>
      ...
      <h2>
        ...
        git commit -m "agora vai. versão final-02"<br />
        git commit -m "correção temporária"<br />
        git commit -m "eu sabia, Deus Sabe, você não sabe"<br />
        git commit -m "deixando um problema para o meu EU do futuro resolver"<br />
        git commit -m "tá funcionando até aqui. não mexe!"<br />
        git commit -m "commitando às cegas, fé no pai"<br />
        git commit -m "parou e agora está funcionando"<br />
        git commit -m "tentativa de conserto nº 7"<br />
        git commit -m "melhorei a gambiarra anterior"<br />
        git commit -m "sim, sou eu de novo"<br />
        git commit -m "tudo sob controle"<br />
        git commit -m "só mais esse ajuste, prometo"<br />
        git commit -m "funcionou no meu PC"<br />
